...
HOTSPOT_STATIC_IPV4="${PROJECT_PI_HOTSPOT_STATIC_IPV4:-10.129.205.32/24}"
HOTSPOT_STATIC_GATEWAY="${PROJECT_PI_HOTSPOT_STATIC_GATEWAY:-}"
HOTSPOT_STATIC_DNS="${PROJECT_PI_HOTSPOT_STATIC_DNS:-8.8.8.8 8.8.4.4}"
...
PROJECT_PI_HOTSPOT_STATIC_IPV4=${HOTSPOT_STATIC_IPV4}
PROJECT_PI_HOTSPOT_STATIC_GATEWAY=${HOTSPOT_STATIC_GATEWAY}
PROJECT_PI_HOTSPOT_STATIC_DNS="${HOTSPOT_STATIC_DNS}"
EOF
